...
impl<E: Executor> crate::mealplan::Module<E> {
    pub async fn range(
        ...
        let start_date = crate::mealplan::date_to_u64(start);
        let end_date = crate::mealplan::date_to_u64(end);
...
#[evento::subscription]
async fn handle_days_generated<E: Executor>(
    context: &Context<'_, E>,
    event: Event<DaysGenerated>,
) -> anyhow::Result<()> {
