...
pub struct Command<E: Executor> {
    ...
    pub subscription: imkitchen_user::subscription::Command<E>,
    pub meal_preferences: imkitchen_user::meal_preferences::Command<E>,
    pub password: imkitchen_user::password::Command<E>,
}
...
impl<E: Executor> Command<E> {
    ...
    {
        Self {
            subscription: imkitchen_user::subscription::Command(state.clone()),
            meal_preferences: imkitchen_user::meal_preferences::Command(state.clone()),
            password: imkitchen_user::password::Command(state.clone()),
            state,
        }
    }
