...
pub struct DatabaseConfig {
    ...
    #[validate(range(min = 1, max = 60, message = "Acquire timeout must be between 1 and 60 seconds"))]
    pub acquire_timeout: u64,
    
    /// Idle timeout in seconds
    #[validate(range(min = 60, max = 3600, message = "Idle timeout must be between 60 and 3600 seconds"))]
    pub idle_timeout: u64,
    
    /// Maximum lifetime in seconds
    #[validate(range(min = 300, max = 7200, message = "Max lifetime must be between 300 and 7200 seconds"))]
...
pub struct ServerConfig {
    ...
    #[validate(range(min = 1024, max = 104857600, message = "Max body size must be between 1KB and 100MB"))]
    ...
    #[validate(range(min = 5, max = 300, message = "Shutdown timeout must be between 5 and 300 seconds"))]
...
pub struct SecurityConfig {
    ...
    #[validate(range(min = 1, max = 10000, message = "Rate limit must be between 1 and 10000 requests per minute"))]
...
pub struct MonitoringConfig {
    ...
    #[validate(range(min = 1, max = 300, message = "Metrics interval must be between 1 and 300 seconds"))]
...
impl Config {
    ...
    pub fn validate_security(&self) -> Result<()> {
        ...
        if !self.security.force_https && !self.server.host.starts_with("127.") && self.server.host != "localhost" {
